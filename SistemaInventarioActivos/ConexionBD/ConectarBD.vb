...
Module ConectarBD
    ...
    Public ip As String = "", user As String = "", password As String = "", bd As String = ""
    ...
    Public Sub establecerconexion()
        Try
            ...
            If File.Exists(Application.StartupPath + "\PASS.txt") Then
                ...
                password = My.Computer.FileSystem.ReadAllText(Application.StartupPath + "\PASS.txt")
            ...
            If ip.Length = 0 Or user.Length = 0 Or password.Length = 0 Or bd.Length = 0 Then

                MsgBox("Faltan parametros de conexion", vbCritical, "ERROR DE CONEXION")

            Else

                conexion = New SqlConnection("Data Source = " & ip.Trim & "; Initial Catalog = " & bd.Trim & "; User Id = " & user.Trim & "; Password = " & password.Trim & ";")
    ...
    Public Function obtenerconexion() As String
        ...
        Try
            ...
            Else
                ...
                miconexion = "Data Source = " & ip.Trim & "; Initial Catalog = " & bd.Trim & "; User Id = " & user.Trim & "; Password = " & password.Trim & ";"
